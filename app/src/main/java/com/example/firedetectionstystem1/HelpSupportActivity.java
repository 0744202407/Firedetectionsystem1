...
public class HelpSupportActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnBackHelp = findViewById(R.id.btnBackHelp);
        ImageButton btnVoiceHelp = findViewById(R.id.btnVoiceHelp);

        btnBackHelp.setOnClickListener(v -> finish());
        if (btnVoiceHelp != null) {
            btnVoiceHelp.setOnClickListener(v -> startVoiceControl());
        }
    }
    ...
    private void startVoiceControl() {
        ...
        if (speechRecognizer == null) {
            ...
            speechRecognizer.setRecognitionListener(new RecognitionListener() {
                @Override public void onReadyForSpeech(Bundle params) { Toast.makeText(HelpSupportActivity.this, R.string.listening, Toast.LENGTH_SHORT).show(); }
                @Override public void onResults(Bundle results) {
                    ArrayList<String> matches = results.getStringArrayList(SpeechRecognizer.RESULTS_RECOGNITION);
                    if (matches != null && !matches.isEmpty()) processVoiceCommand(matches.get(0).toLowerCase());
                }
                @Override public void onError(int error) { Toast.makeText(HelpSupportActivity.this, R.string.voice_error, Toast.LENGTH_SHORT).show(); }
